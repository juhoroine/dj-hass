...
async def validate_input(hass: HomeAssistant, data: dict[str, str, str, Any]) -> None:
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        self, user_input: dict[str, str, str, Any] | None = None
    ) -> FlowResult:
        ...
        try:
            logging.info("validaattorille: ", user_input)
